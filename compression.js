...
exports.cityHash128LE = exports.decodeBlocks = exports.decodeBlock = exports.encodeBlock = exports.Method = void 0;
...
exports.cityHash128LE = cityHash128LE;
/**
...
function decodeBlock(block, skipChecksumVerification = false) {
    ...
    if (mode === Method.None)
        return compressed;
    if (mode === Method.LZ4)
        return lz4DecompressCH(compressed, uncompressedSize);
    if (mode === Method.ZSTD)
        return zstdDecompressCH(compressed);
    throw new Error(`Unsupported compression method 0x${mode.toString(16)}`);
}
