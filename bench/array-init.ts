...
function runSuite(size: number) {
  ...
  console.log(`new Array(n):              ${benchmark('holey', createHoley).toFixed(3)}ms`);
  console.log(`new Array(n).fill(undef):  ${benchmark('fill-undef', createFillUndefined).toFixed(3)}ms`);
  console.log(`new Array(n).fill(null):   ${benchmark('fill-null', createFillNull).toFixed(3)}ms`);
  console.log(`new Array(n).fill(0):      ${benchmark('fill-zero', createFillZero).toFixed(3)}ms`);
  console.log(`new Array(n).fill(''):     ${benchmark('fill-string', createFillString).toFixed(3)}ms`);
  console.log(`[].push() loop:            ${benchmark('push-loop', createPush).toFixed(3)}ms`);
  ...
  console.log(`write to holey:            ${benchmark('write-holey', writeToHoley).toFixed(3)}ms`);
  console.log(`write to fill(null):       ${benchmark('write-fill-null', writeToFillNull).toFixed(3)}ms`);
  console.log(`write to fill(0):          ${benchmark('write-fill-zero', writeToFillZero).toFixed(3)}ms`);
  console.log(`push loop:                 ${benchmark('write-push', writePush).toFixed(3)}ms`);
  ...
  console.log(`read holey array:          ${benchmark('read-holey', readHoley).toFixed(3)}ms`);
  console.log(`read packed array:         ${benchmark('read-packed', readPacked).toFixed(3)}ms`);
  ...
  console.log(`Date to holey:             ${benchmark('date-holey', writeDateToHoley).toFixed(3)}ms`);
  console.log(`Date to fill(null):        ${benchmark('date-fill-null', writeDateToFillNull).toFixed(3)}ms`);
  console.log(`Date to fill(shared):      ${benchmark('date-fill-shared', writeDateToFillShared).toFixed(3)}ms`);
  ...
  console.log(`String to holey:           ${benchmark('str-holey', writeStringToHoley).toFixed(3)}ms`);
  console.log(`String to fill(''):        ${benchmark('str-fill-empty', writeStringToFillEmpty).toFixed(3)}ms`);
  console.log(`String to fill(null):      ${benchmark('str-fill-null', writeStringToFillNull).toFixed(3)}ms`);
}
